...
function Menu() {
  return (
    <Popup
    trigger={<div className='menu'><MenuIcon /></div>}
    >
      <div className="modal">
        <h1>Menu</h1>
      ...
      <p>Welcome</p>
         ...
         <div className='event'>
        <LocalActivityOutlinedIcon style={{color:"blue",height:120}}/>
        <p>Events</p>
         </div>
         <div className='friends'>
         <PeopleOutlinedIcon style={{color:"blue",height:90}} />
         <p>Find Friends</p>
         </div>
         <div className='groups'>
       <Diversity1OutlinedIcon style={{color:"blue",height:90}} />
       <p>Groups</p>
